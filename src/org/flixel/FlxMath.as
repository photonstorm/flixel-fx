/**
 * FlxMath - Adds a set of fast Math functions (or extends commonly used ones)
...
package org.flixel 
{
	public class FlxMath
	{
		...
		//static public function set cosTable(data:Array):void
		//{
			//
		//}
		 ...
		 * @see getCosTable
		 */
		static public function sinCosGenerator(length:uint, sinAmplitude:Number = 1.0, cosAmplitude:Number = 1.0, frequency:Number = 1.0):void
		{
		 ...
		 * @see sinCosGenerator
		 */
		static public function getSinTable():Array
		{
			return sinTable;
		}
		 ...
		 * @see sinCosGenerator
		 */
		static public function getCosTable():Array
		{
			return cosTable;
		}
		 ...
		 */
		static public function miniRand():int
		{
			var result:uint = mr;
		 ...
		 */
		static public function rand(min:Number = NaN, max:Number = NaN, excludes:Array = null):int
		{
			if (isNaN(min))
			{
				min = 0;
		 ...
		 * @return A pseudo random value between min (or 0) and max (or getrandmax, inclusive)
		 */
		static public function randFloat(min:Number = NaN, max:Number = NaN):Number
		{
			if (isNaN(min))
			{
				min = 0;
		 ...
		 */
		static public function chanceRoll(chance:uint = 50):Boolean
		{
			if (chance <= 0)
			{
				return false;
		 ...
		 */
		static public function asDegrees(radians:Number):Number
		{
		 ...
		 */
		static public function asRadians(degrees:Number):Number
		{
		 ...
		 */
		static public function powerOf2mod(value:uint, divisor:uint):uint
		{
			return value & (divisor - 1);
		}
		
		/**
		 * Experimental - Performs an "Is Even" check against the given value
		 * @param	value
		 * @return true if the value is even, false if not
		 */
		
		static public function isEven(value:Number):Boolean
		{
			return (value & 1) == 0;
		}
